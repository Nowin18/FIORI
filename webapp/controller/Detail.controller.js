sap.ui.define([
    ...
    return BaseController.extend("projectv2.controller.Detail", {
        ...
        onDelete: function(oEvent) {
            ...
            // var path = oTable.getElementBinding();//.byId("object"); //.byId("object").getValue();
            // var clickedItemPath = oEvent.getSource().getBindingContext().getPath();
            // const idItem = clickedItemPath.slice(10, -1);
			...
			return new Promise(function(fnResolve, fnReject) {
				if (oSourceBindingContext) {
					var oModel = oSourceBindingContext.getModel();
					 oModel.remove(oSourceBindingContext.getDeepPath() /*oSourceBindingContext.getPath()*/, {
						success: function() {
							oModel.refresh();
							fnResolve();
						},
